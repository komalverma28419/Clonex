        ...
        <div className='max-w-7xl mx-auto px-7 lg:px-12 xl:px-14'>
            <div className='flex flex-col items-center justify-center'>
                ...
                <div className='relative overflow-hidden w-full mt-12'>
                    <div className="absolute left-0 top-0 z-10 h-full w-24 bg-gradient-to-r from-white dark:from-[#02061a] to-transparent" />
                    ...
                    <div className="absolute right-0 top-0 z-10 h-full w-24 bg-gradient-to-l from-white dark:from-[#02061a] to-transparent" />
                </div>
            </div>
        </div>
